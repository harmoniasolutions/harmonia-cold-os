  ...
  tabs: {
    LEADS: {
      ...
      fields: {
        ...
        disposition:       { sheetColumn: 'disposition',      column: 'V', required: true },  // NEW
        objection_raised:  { sheetColumn: 'objection_raised', column: 'W', required: false }, // NEW
        caller_name:       { sheetColumn: 'caller_name',     column: 'X', required: true },   // NEW
      }
    },
...
export const SCRIPT_OPTIONS = {
  ...
  salon: [],      // populate when salon scripts are added
  dental: [],     // populate when dental scripts are added
  barbershop: [], // populate when barbershop scripts are added
};
...
// Caller options
export const CALLER_OPTIONS = ['Pete', 'Julian'];
