...
export default function HarmoniaOS() {
  ...
  async function dial(lead){
    ...
    try{ await fetch(url,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain"},body:JSON.stringify({cnum:caller,bnum:lead.phone})}); }
                  ...
                  <div style={{paddingLeft:12}}>
                    ...
                    {isDone&&(
                      <div style={{marginTop:3,fontSize:10,fontWeight:500,
                        ...
                        {lead.status==="demo_booked"?"✦ Demo booked":"Called"}
